    ...
    <div class="w-full max-w-[28rem] relative z-10">
        ...
        <div class="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10 relative overflow-hidden">
            ...
            <div class="text-center mb-8">
                <a href="<?php echo e(route('kiosk.index')); ?>" title="Back to Kiosk" class="inline-block transition-transform hover:scale-105 active:scale-95 cursor-pointer">
                    <img src="/CorJesu Logo.png" alt="CJC Logo" class="w-[4.5rem] h-[4.5rem] object-contain mx-auto mb-4 drop-shadow-sm" onerror="this.src='/logo.png'">
                </a>
            ...
            <form action="<?php echo e(route('admin.login.post')); ?>" method="POST" class="space-y-6" x-data="{ isSubmitting: false }" @submit="isSubmitting = true">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="you@cjc.edu.ph" required autofocus 
...
<div x-data="{ open: false }" 
    ...
    <div x-show="open"
        ...
        <div class="p-6">
            ...
            <form action="<?php echo e(route('admin.signup')); ?>" method="POST" class="space-y-5" x-data="{ isRegistering: false }" @submit="isRegistering = true">
                <?php echo csrf_field(); ?>
                <div>
                ...
                <div class="grid grid-cols-2 gap-4" x-data="{ showPassword: false }">
                    <div>
                        ...
                        <div class="relative">
                            <input :type="showPassword ? 'text' : 'password'" name="password" placeholder="••••••••" required minlength="8" 
                                   class="w-full px-4 py-3 pr-11 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-gray-100 focus:border-gray-300 transition-colors">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input :type="showPassword ? 'text' : 'password'" name="password_confirmation" placeholder="••••••••" required minlength="8" 
                                   class="w-full px-4 py-3 pr-11 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-gray-100 focus:border-gray-300 transition-colors">
                            <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 focus:outline-none">
                                <svg x-show="!showPassword" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                <svg x-show="showPassword" style="display:none;" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" /></svg>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Alfie Lynard\OneDrive\Desktop\archive\LEMS\resources\views/admin/login.blade.php ENDPATH**/ ?>