            ...
            <header class="flex items-center justify-between px-12 py-5 shrink-0 z-20">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="<?php echo e(route('about.index')); ?>" @click.stop class="inline-flex items-center gap-1.5 text-[12px] font-semibold text-[var(--cjc-navy)] font-['Inter'] no-underline px-4 py-1.5 border border-[var(--border-warm)] shadow-sm rounded-full bg-white/80 hover:bg-white transition-all backdrop-blur-md">
                            About Us
                        </a>
                        <a href="<?php echo e(route('register.index')); ?>" @click.stop class="inline-flex items-center gap-1.5 text-[12px] font-semibold text-[var(--cjc-navy)] font-['Inter'] no-underline px-4 py-1.5 border border-[var(--border-warm)] shadow-sm rounded-full bg-white/80 hover:bg-white transition-all backdrop-blur-md">
                            Register
                        </a>
                        <a href="<?php echo e(route('admin.login')); ?>" @click.stop class="inline-flex items-center gap-1.5 text-[12px] font-semibold text-[var(--cjc-navy)] font-['Inter'] no-underline px-4 py-1.5 border border-[var(--border-warm)] shadow-sm rounded-full bg-white/80 hover:bg-white transition-all backdrop-blur-md">
                            Admin
                        </a>
                    </div>
                </div>
...
<?php /**PATH C:\Users\Alfie Lynard\OneDrive\Desktop\archive\LEMS\resources\views/components/kiosk/idle-state.blade.php ENDPATH**/ ?>