                        ...
                        @forelse($students as $student)
                            <tr class="hover:bg-gray-50/80 transition-colors">
                                ...
                                <td class="p-4 text-right whitespace-nowrap">
                                    ...
                                    <form action="{{ route('admin.students.destroy', $student->id) }}" method="POST" class="inline-block mr-1" onsubmit="return confirm('Are you sure you want to delete this patron? This action cannot be undone.');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="text-xs font-semibold px-3 py-1.5 rounded bg-red-100 hover:bg-red-200 text-red-700 transition-colors">
                                            Delete
                                        </button>
                                    </form>
                                    @endif
                    ...
                    <form :action="`/admin/students/${selectedStudent?.id}/violations`" method="POST">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select name="violation_type_id" required class="w-full p-2 border border-gray-300 rounded focus:border-[var(--cjc-navy)] outline-none text-sm bg-white">
